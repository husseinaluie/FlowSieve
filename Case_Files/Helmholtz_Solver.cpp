...
int main(int argc, char *argv[]) {
    ...
    Helmholtz_Solver( "output.nc", source_data, tolerance, max_iterations, iters_per_cycle, use_area_weight,
           use_mask, use_vel, use_vort_div, collapse_land, num_refinements );
