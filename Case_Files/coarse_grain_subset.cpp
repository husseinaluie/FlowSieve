...
int main(int argc, char *argv[]) {
    ...
    std::vector<double> window_scales { 100e3, 250e3, 500e3, 750e3 };
    ...
    //    do not split across MPI processes. Instead we'll split the sample loop
    read_var_from_file(u_lon, "uo", "input.nc", &mask, &myCounts, &myStarts, false);
    read_var_from_file(u_lat, "vo", "input.nc", &mask, &myCounts, &myStarts, false);
