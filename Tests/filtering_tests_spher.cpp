...
int main(int argc, char *argv[]) {
    ...
    for (int Ilat = 0; Ilat < Nlat; Ilat++) {
        for (int Ilon = 0; Ilon < Nlon; Ilon++) {
            index = Index(0, 0, Ilat, Ilon, 1, 1, Nlat, Nlon);
            field.at(index) = constant_field(latitude.at(Ilat), longitude.at(Ilon));
        }
    }
    ...
    for (int Ilat = 0; Ilat < Nlat; Ilat++) {
        for (int Ilon = 0; Ilon < Nlon; Ilon++) {
            index = Index(0, 0, Ilat, Ilon, 1, 1, Nlat, Nlon);
            field.at(index) = linear_lon_field(latitude.at(Ilat), longitude.at(Ilon));
        }
    }
    ...
    for (int Ilat = 0; Ilat < Nlat; Ilat++) {
        for (int Ilon = 0; Ilon < Nlon; Ilon++) {
            index = Index(0, 0, Ilat, Ilon, 1, 1, Nlat, Nlon);
            field.at(index) = linear_lat_field(latitude.at(Ilat), longitude.at(Ilon));
        }
    }
